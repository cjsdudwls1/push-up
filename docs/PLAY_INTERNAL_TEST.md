...
- 국내 개인사업자도 D-U-N-S를 받아 조직 계정을 만들 수는 있습니다. 그런데 여러 국내 개발자가
  ...
  있음).
- 지금은 테스트 기간 내내 전부 무료라(DECISIONS.md) 판매자 결제 프로필이 당장 필요하지는 않습니다.
  하지만 수익 모델을 정해서 인앱 결제로 벌게 되면, 개인사업자로 가도 결국 개인 계정이 되고
  12명 × 14일을 거칩니다. 면제를 받으면서 수익도 받으려면 법인이 필요합니다.
